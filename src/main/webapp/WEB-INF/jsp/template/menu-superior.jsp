...
<div class="navbar navbar-default" id="navbar">
	...
	<div class="navbar-container" id="navbar-container">
		<div class="navbar-header pull-left">
			<a href="<c:url value="/index"/>" class="navbar-brand"> <small> <i
					class="icon-leaf"></i> Projeto base com vraptor 4
			</small>
			</a>
			<!-- /.brand -->
		</div>
			...
			<ul class="nav ace-nav">
				...
				<li class="light-blue"><a data-toggle="dropdown" href="#"
					class="dropdown-toggle"> <img class="nav-user-photo"
						src="${ctx}/resources/tema-admin/assets/avatars/user.jpg" alt="Jason's Photo" /> <span
						class="user-info"> <small>Bem vindo,</small> ${userInfo.usuarioLogado.nome}
					...
					<ul
						...
						<li><a class="languageFlag" href="?language=pt_BR"><img
								src="${ctx}/resources/tema-admin/assets/images/flags/br.png" alt="br" /> <fmt:message key="idioma.portugues" /></a></li>
						<li><a class="languageFlag" href="?language=en"><img
								src="${ctx}/resources/tema-admin/assets/images/flags/us.png" alt="en" /> <fmt:message key="idioma.ingles" /></a></li>

						<li><a href="<c:url value="/logout"/>"> <i
								class="icon-off"></i> <fmt:message key="login.sair" />
						</a></li>
					</ul></li>
			</ul>
			<!-- /.ace-nav -->
